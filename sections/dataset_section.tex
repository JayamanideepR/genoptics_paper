...
The collected corpus retains the source-specific operating conditions available for each design, whereas the common field-sampling conventions used to form the canonical subset are introduced in Section~\ref{sec:dataset_patent_shortlisting}.
...
The tabular prescription also retains optical-performance annotations generated during evaluation. The annotations used in this study include:
\begin{enumerate}
...
\end{enumerate}
The schema additionally retains the performance and sensitivity annotations used in the canonical dataset.\\
