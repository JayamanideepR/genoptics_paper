...
\toprule
\textbf{Metric family} & \textbf{Feasibility} & \multicolumn{4}{c}{\textbf{Distribution matching}} & \shortstack{\textbf{Novelty /}\\\textbf{train proximity}} \\
...
\captionof{table}{\textbf{Effect of physics based post-processing on TabSyn tuned 250k generated samples.} Both branches use the same 10{,}000 generated-row denominator. Success among submitted is computed only over rows that passed preparation and were submitted to CodeV/LLESP.}
