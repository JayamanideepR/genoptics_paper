...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures/model_processing_pipeline_tikz.pdf}
    \caption{\textbf{Model-facing data and post-processing pipeline.} Canonical prescriptions pass through train/test splitting, representation-specific preprocessing, and model-specific formatting before model training and sampling. Generated rows are inverted to canonical prescriptions, corrected by physics-based post-processing, and evaluated in CodeV. Colors distinguish data artifacts, deterministic transformations, learned operations, and physics/CodeV stages.}
